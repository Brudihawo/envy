...
{body_pre}
{body}
<div id='search_parent' class='search'>
    <div class='cover'></div>
    <div class='search_in'>
        <div class='search_head'>
            <h2 id='h_search_head'>Search</h2>
            <input id='search_input' type='text' onkeyup='update_search()' placeholder='search...'/>
        </div>
        <div id='search_res_div' class='search_res'></div>
    </div>
</div>
